        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">iPhone</a>
                    ...
                    <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">iPad</a>
                    <ul class="dropdown-menu">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Mac</a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Watch</a>
                    <ul class="dropdown-menu">
                ...
                <form class="d-flex" role="search">
                    <input class="form-control me-2" type="search" placeholder="iPhone 15 Pro Max" aria-label="Search">
            ...
            <div class="col-sm">
                ...
                <img src="src/img/15.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        ...
                        <p class="card-text">iPhone 15 and iPhone 15 Plus. Dynamic Island. 48MP Main camera with 2x Telephoto. All-day battery life. USB-C. 6.1” and 6.7” sizes.</p>
                        <a href="#" class="btn btn-primary">Buy</a>
                        <a href="#" class="btn btn-secondary">More</a>
                    </div>
                </div>
            ...
            <div class="col-sm">
                ...
                <img src="src/img/macbookpro.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        ...
                        <p class="card-text">MacBook Pro with M3, M3 Pro, and M3 Max chips. Up to 22 hours of battery life. The world’s best laptop display. Now in a new color: Space Black.</p>
                        <a href="#" class="btn btn-primary">Buy</a>
                        <a href="#" class="btn btn-secondary">More</a>
                    </div>
                </div>
            ...
            <div class="col-sm">
                ...
                <img src="src/img/macmini.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        ...
                        <p class="card-text">Supercharged by the M2 or M2 Pro chip, Mac mini has a wide array of ports and Wi-Fi 6E for a phenomenal desktop experience.</p>
                        <a href="#" class="btn btn-primary">Buy</a>
                        <a href="#" class="btn btn-secondary">More</a>
                    </div>
                </div>
            ...
            <div class="col-sm">
                ...
                <img src="src/img/macbookair.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        ...
                        <p class="card-text">MacBook Air is supercharged by M1 and M2 chips. Featuring FaceTime HD camera, Touch ID, and vibrant Retina display.</p>
                        <a href="#" class="btn btn-primary">Buy</a>
                        <a href="#" class="btn btn-secondary">More</a>
                    </div>
                </div>
